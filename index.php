                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="topbar-text">
                            <ul class="list-inline text-right">
                                <li class="list-inline-item"><a href="login.php"><span class="fas fa-user mr-2"></span> Login</a></li>
                                <li class="list-inline-item"><a href="login.php"><span class="fas fa-lock mr-2"></span> Register</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div id="navBar" class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto main-navbar-nav">
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-md-6">
                                            ...
                                            <div class="title-with-icon-item">
                                                <a class="title-with-icon-link" href="login.php">
                                                    <div class="media">
                            ...
                            <li class="nav-item header-nav-last-item d-flex align-items-center">
                                <a class="btn primary-solid-btn animated-btn" href="login.php" target="_blank">
                                    Get Started
                                </a>
                            </li>
                            <!--button end-->
                    ...
                    <div class="col-md-8 col-lg-8">
                        <div class="hero-content-wrap text-white position-relative z-index">
                            ...
                            <div class="action-btns mt-5">
                                ...
                                <a href="login.php" class="btn outline-white-btn">Package Comparision</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4">
                                ...
                                <tbody class="comparision-table-body">
                                    <tr>
                                        ...
                                        <td class="py-4">
                                            ...
                                            <a href="login.php" class="btn primary-solid-btn mt-2">Get Started</a>
                                        </td>
                                        <td class="py-4">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="features-box p-4">
                            ...
                            <div class="features-box-content">
                                ...
                                <p>Our intuitive control panel gives you admin access to all of your DreamHost products. Easily update domain information, add users, adjust email settings gain access.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="features-box p-4">
                            ...
                            <div class="features-box-content">
                                ...
                                <p>Tech veterans, geeks, and nerds are all standing by to optimize your experience. Whether you get in touch with our support, read our knowledge base, or start a thread.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="features-box p-4">
                            ...
                            <div class="features-box-content">
                                ...
                                <p>No need to dig into a bunch of documentation. Simply install web apps like WordPress, Joomla! and more. Monotonectally administrate economically sound opportunities.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="features-box p-4">
                            ...
                            <div class="features-box-content">
                                ...
                                <p>With multiple datacenter locations, redundant cooling, emergency generators, and constant monitoring, we are able to offer our 100% Uptime Guarantee.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="features-box p-4">
                            ...
                            <div class="features-box-content">
                                ...
                                <p>No question is too simple, or too complex for our team of experts. Synergistically synergize Our in-house support staff and service team are here for you 24/7, 365.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-9 col-lg-8">
                        <div class="cta-new-wrap text-white text-center">
                            ...
                            <div class="action-btns mt-4">
                                <a href="login.php" class="btn solid-white-btn animated-btn mr-lg-3">Get
                                    Started Now</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="accordion-one" class="accordion accordion-faq">
                            ...
                            <div class="card mb-0">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapseTwo">
                                    <h6 class="mb-0 d-inline-block">What Are the Different Types of Web Hosting Products DreamHost Offers?</h6>
                                </a>
                            ...
                            <div class="card mb-0">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapseThree">
                                    <h6 class="mb-0 d-inline-block">How Do I Buy a Domain Name?
                                    </h6>
                                </a>
                            ...
                            <div class="card mb-0">
                                <a class="card-header collapsed" data-toggle="collapse" href="#collapseFour">
                                    <h6 class="mb-0 d-inline-block">Can You Help Me Understand More About WordPress?
                                    </h6>
                                </a>
                                <div id="collapseFour" class="collapse" data-parent="#accordion-one">
                                    <div class="card-body">
                                        <p>Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="footer-nav-wrap text-white">
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="login.php">WordPress Hosting</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="login.php">Shared Hosting</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="login.php">Virtual Private Servers</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="login.php">Dedicated Servers</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="login.php">Domain Names</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-5 col-lg-5">
                        <p class="copyright-text pb-0 mb-0">Copyrights © 2024. All rights reserved by
                            <a href="#" target="_blank">Hostlar</a>
                        </p>
                    </div>
